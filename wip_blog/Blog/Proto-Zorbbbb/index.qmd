...
date: "2026-3-10"
categories:  [Conlangs]
abstract: My showcase for Proto-Zorbbbb, the ancestor of Zorbbbb and possibly Limit and West Jikur Sign Language. 
---

# Introduction

I made a conlang out of a friend's Discord username. If you know you know. Otherwise don't ask. Hopefully, this language is better Limit, because 
...
Since each syllable has a specified musical note and length (as you will see soon), stress really doesn't exist from these factors. However, the only hope for having prosody is loudness and octave, which are not phonemic. 

Loudness is either normal or loud, and it's relative. 
