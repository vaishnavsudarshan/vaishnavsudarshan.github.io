...
date: "2026-3-10"
categories:  [Linguistics, Conlangs]
abstract: Where morphology and syntax have a sequel.
---
...
Since each syllable has a specified musical note and length, stress really doesn't exist. 

## Orthography

Since the main meaning of a word comes from 

* Abjad
* Allograph for start of a word - upside down
* Cursive

# Lore

Proto-Zorbbbb is what evolved later into Zorbbbb, and strongly influenced West Jikur Sign Language, and Limit. Some Limitial linguists believe that Proto-Zorbbbb may be the ancestor of Limit and WJSL, but it's hard to prove. Zorbbbb is nowadays a dead language since Zorbbbbistan no longer exists, but many Proto-Zorbbbb resources are found in the corners of Limitland, in ancient Zorbbbbistani buildings. 

West Jikur is a city in rural Limitland inhabited by aliens who can process frequencies, just from mechanical oscillations rather than sound waves. More on that in a future blog post. 
...
The Proto-Zorbbbbistanis invented their own orthography. Later, with the arrival of English to the planet Zorbbbb, they made their own romanization to teach newcomers their language. There is a second romanization that is only used for typing (the default graph's first letter). 
...
Proto-Zorbbbbistanis, however, were very greedy but in a weird way. At the annual national Zorbbbbistani meeting, there were $n$ candies to eat. The representatives of each territory hated equality within their own land. Representatives didn't want every single person in their constituency, including themselves, who received a candy to receive the same amount of candies, so a composite number wouldn't do. A prime number would ensure that if the candies were distributed evenly, everyone who got a candy would either get a single one, or one person would get all of them. 

A national law had three parts: 
...
Adpositional recursion is simple - just use noun cases. These always occur before  
