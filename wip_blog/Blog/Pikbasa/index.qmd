...
By the way, now's a good time to come clean. Pikbasa is technically not a language. One of the characteristics of a language is that it is productive - a finite amount of building blocks can make infinite sentences. On the other hand, a Pikbasa sentence has $25$ words (more details on that in the next section), each with at most $64$ possible distinguished colors. While $64^{25}$ s an upper bound is huge, it's not infinite, making Pikbasa not productive. I assume, however, that most of you reading this are not annoying "erm actually" people, so Pikbasa is a language for the purposes of this showcase. 
