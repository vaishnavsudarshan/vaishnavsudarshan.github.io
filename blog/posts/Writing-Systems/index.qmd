...
abstract: How do different types of writing systems work? What are they evolved from, and how? All these and more will be answered in this blog post. 
...
"二"
So, sometimes, the symbol looks like what it means. However, many logographic symbols have evolved so much that they don't seem to resemble what they mean. For example, "马" means "horse" (pronounced as "ma"). This looks nothing like a horse, but the ancient form of this symbol did. 

 Sometimes, it can be more complicated than this. In Mandarin, each symbol is generally one syllable as well, and sometimes symbols are made based on their relation with other semantic meanings, so you can build up symbols from smaller symbols. For example, the symbol for "forest" is:
 森
...
OK, that phonetic writing system stuff was cool, but you need to know how sounds actually work to use the symbols that represent them. Read [phonetics](https://vaishnavs.net/posts/Phonetics/) to find out how!

# Challenge yourself with these NACLO problems

Also, now that you know about writing systems, try out these problems!

[Hmong](https://www.naclo.org/resources/problems/2007/N2007-D.pdf)

[Putting a Place to a Name](https://www.naclo.org/resources/problems/2021/N2021-K.pdf)

[Around the World in Armenian](https://naclo.org/resources/problems/2025/N2025-E.pdf)

Unlike other blog posts where I put the problem right next to the corresponding information section, here I put them problems in their own section. This is because a big part of the problems is to find out what system they use.

# Further Information

* [This article](https://sites.utexas.edu/dsb/tokens/the-evolution-of-writing/) is 