...
The name of a language family, which is a group of languages that are all related to each other, usually shares a name with of the proto-language. For example, the Indo-European language family descends from Proto-Indo-European, and the Dravidian language family descends from Proto-Dravidian.
