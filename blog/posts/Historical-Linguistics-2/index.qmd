...
date: "2026-6-30"
categories:  [Linguistics, History]
tags: [Logic, Geography, History, Anthropology]
image: "hundred.png"
abstract: How did historical linguists figure out the ancestor language to all the Indo-European languages? Or the Dravidian languages? Or any other group of languages that people believe to be related? The comparative method is how.
---
...
However, there is a certain technique that is used to reconstruct many such ancestor words to a pretty confident degree of accuracy, called the comparative method. And if you had many more words and many more languages, you could even be able to reconstruct the entire ancestor language and even understand a bit about the culture of its speakers. By the way, the answer is *tréyes. 
...
Note that the Romance languages, descended from Latin, pronounced it as [s], not [k] - it's coincidentally the same sound change that caused the centum-satem split, but it happened much later. Additionally, the satem languages don't necessarily pronounce the first consonant as exactly [s], but it is generally a voiceless fricative in around that area, like [ʃ] for instance.
...
Sometimes, if a sound change pushes one sound into another existing sound, then that sound will turn into another sound to maintain the distinction, and so on. This is called a push chain.

An example of this is the Great Vowel Shift in English. /e:/ (beet) and /o:/ (boot) sounded more like /i:/ and /u:/, so /i:/ (time) and /u:/ (house) sounded more like /aɪ/ and /aʊ/. 

The reverse may also happen. If a sound change turns into another sound that didn't exist before, then the previous sound is unused, so another sound may turn into that, and so on, and this is called a pull chain.

# Common Sound Changes

Here are the most common types of sound changes:

* Assimilation: A sound becomes more like its neighbors, like "octo" in Latin turning into "otto" in Italian (the /k/ became a /t/)
* Dissimilation: A sound tries to contrast with its neighbors more (like saying "February" as "Febyuary")
* Insertion: A sound must be added to make the word easier to say (like "something" ocassionally having a [p] between the /m/ and /θ/)
* Deletion: A sound disappears (the /k/ in "knight" actually used to be pronounced)
* Metathesis: Two sounds get replaced (like how my sister once said "can we please stop having this conservation" instead of "conversation")
* Strengthening: A sound becomes more like a consonant (some people pronounce "this" as "dis" because stops are more consonant-like than fricatives)
* Weakening: A sound becomes more like a vowel (Grimm's law where stops became fricatives)

# Analogy and Morphological Change

Sometimes, analogies cause speakers to change a language's morphology and make it more regular. I've seen this happening to my sister. Often, she says "drinked" and "hurted" for past tense instead of "drank" and "hurt". In fact, relatively less common words are more likely to be regularized by analogy, because speakers are less likely to interact with all the irregularity. This is why you'll never find my sister saying "eated" or "haved". 
...
Some people might be surprised about a famous observation in historical linguistics, that Sanskrit is more mutually intelligible with Lithuanian than it is with Hindi, even though Hindi is a direct descendant of Sanskrit, while Lithuanian isn't even Indo-Iranian. 
...
* I'd recommend the book ["Proto"](https://www.goodreads.com/en/book/show/217387741-proto) by Laura Spinney if you want a broader picture of how the Indo-European languages spread, using not just linguistics but also archaeology and genetics. For example, it goes more in depth into why the Baltic languages are conservative (yet they've still innovated in different aspects like the copula), or how we know the Indo-Europeans (we're not sure about Anatolians, though) had wheels. 

* The history behind pairs of animal names in English where one is French and one is native Germanic is best explained through Oversimplified's [Battle of Hastings video](https://www.youtube.com/watch?v=Jl3K63Rbygw). 

* This famous paper [The Case Against The Altaic Theory](https://altaica.ru/LIBRARY/CLAUSON/Clauson_against.pdf) provides a really good explanation as to why the Altaic Hypothesis is probably false and was very influential.

* This [paper](https://websites.umich.edu/~thomason/papers/areas.pdf) goes more in detail about how sprachbunds work. 
