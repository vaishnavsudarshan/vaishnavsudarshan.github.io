...
Most people would agree that a language is a system to communicate with others. Some characteristics linguists define are the following (just to name some of the main ones):

* Productive - able to infinite sentences from a finite set of building blocks

* Systematic - contains rules for what is grammatical

* Displacement - can refer to things that aren't right in front of someone while they're speaking

* Arbitrary/Duality - arbitrarily constructs meaning from meaningless units
