...
"A or B" can also mean the logical "xor", where only one of them is true, not both. If someone says "you will choose chocolate or vanilla", and each person gets exactly one full scoop, you can't get two people's worth of ice cream by getting both. 
