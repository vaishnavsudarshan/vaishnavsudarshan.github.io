...
Since sound and meaning are independent, know that something like alliteration being meaningful for a piece of literature is not a linguistic thing, but rather a psychological thing. 
...
Polysynthetic languages are like an extreme form of regular synthetic languages. A single word could contain the meaning of an entire sentence, combining morphemes of subjects, objects, and verbs. You may have seen super long words of some indigenous languages of the Eskimo-Aleut family in Greenland, Alaska, and Northern Canada, and wondered what they were yapping. Now you know it's not actual yap, just a normal sentence put together into a giant word. 

#### Clarification on "Words"

But hold on, I thought words aren't reliable measurements, so why do we use words here? In the case specifically for morphological typology, a "word" is just something that cannot be broken apart by syntax - and it's not based on writing (for example, under this definition, "mitbringen", meaning "to bring along" in German, is actually two words, "mit" + "bringen", because "I bring along" would be "Ich bringe mit"). It's mainly for thinking about the general density of morphemes. We don't care about the definitions that are useful for semantics or orthography. 

The idea of free and bound morphemes can also help to clarify this - bound morphemes obviously can't count as their own word, so it's basically asking how many bound morphemes are attached in a word. 
