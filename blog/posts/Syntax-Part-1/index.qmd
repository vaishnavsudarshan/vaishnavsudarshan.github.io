...
Tamil, on the other hand, is a head-final language. The equivalent VP to "ate the cake" would be "cake sappitten", and that last word means "(I) ate", which is a verb, so the phrase can be decomposed as NP V.  Tamil also uses postpositions. The postpositional phrase "to the house" would be "veetu ku" (/ʋi/)
