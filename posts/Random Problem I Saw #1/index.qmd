...
# Actual Solution 
Assume there are $n$ numbers being added up. $1 \leq n \leq 8$, since there are at most eight numbers, one per digit, and at least one number, which is when all the digits are in one number. 
